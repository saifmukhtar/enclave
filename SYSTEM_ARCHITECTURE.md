...
*This document was generated by reading every `package.json`, `build.gradle.kts`, `docker-compose.yml`, `.env.example`, SQL migration, and key source file in the repository. No guesses. No assumptions. 100% sourced from actual code.*
