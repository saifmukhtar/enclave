...
class MessageSenderUseCase(
    ...
    suspend fun sendTimeCapsuleMessage(text: String, sendAt: Long) = withContext(Dispatchers.IO) {
        ...
        val capsule = dev.saifmukhtar.enclave.data.local.TimeCapsuleEntity(
            id = messageId,
            targetId = partnerId,
        ...
        val req = androidx.work.OneTimeWorkRequestBuilder<dev.saifmukhtar.enclave.worker.TimeCapsuleWorker>()
