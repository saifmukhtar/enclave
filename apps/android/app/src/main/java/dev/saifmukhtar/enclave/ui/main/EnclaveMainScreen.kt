package dev.saifmukhtar.enclave.ui.main
...
import androidx.compose.animation.core.Spring
import dev.saifmukhtar.enclave.ui.theme.RoseDeep
...
import dev.saifmukhtar.enclave.ui.call.CallLogScreen
import dev.saifmukhtar.enclave.ui.call.CallViewModel
import dev.saifmukhtar.enclave.ui.call.VideoCallScreen
import dev.saifmukhtar.enclave.ui.chat.ChatScreen
import dev.saifmukhtar.enclave.ui.chat.ChatViewModel
import dev.saifmukhtar.enclave.ui.kiss.KissViewModel
import dev.saifmukhtar.enclave.ui.kiss.KissWorkflowViewModel
import dev.saifmukhtar.enclave.ui.lounge.LoungeScreen
import dev.saifmukhtar.enclave.ui.lounge.LoungeViewModel
import dev.saifmukhtar.enclave.ui.lounge.tabs.*
import dev.saifmukhtar.enclave.ui.profile.ProfileScreen
import dev.saifmukhtar.enclave.ui.profile.ProfileViewModel
import dev.saifmukhtar.enclave.ui.profile.StatusStoriesScreen
import dev.saifmukhtar.enclave.ui.profile.StoryViewModel
import dev.saifmukhtar.enclave.ui.vault.BiometricPromptManager
import dev.saifmukhtar.enclave.ui.vault.VaultScreen
...
fun EnclaveMainScreen(
    ...
    val screenCaptureLauncher = rememberLauncherForActivityResult(
        ...
        if (result.resultCode == android.app.Activity.RESULT_OK && result.data != null) {
            val serviceIntent = android.content.Intent(context, dev.saifmukhtar.enclave.webrtc.ScreenShareService::class.java)
    ...
    val activity = context as dev.saifmukhtar.enclave.MainActivity
    LaunchedEffect(callState) {
        if (callState == dev.saifmukhtar.enclave.ui.call.CallState.ACTIVE) {
        ...
        Scaffold(
                                    ...
                                    Column(
                                        ...
                                        if (tabId == "stories") {
                                            ...
                                            BadgedBox(badge = {
                                                ...
                                                Icon(
                                                    ...
                                                    tint = if (isSelected) dev.saifmukhtar.enclave.ui.theme.RoseDeep else Color(0xFF7A6A6C)
                                                )
                                            }
                                        } else {
                                            Icon(
                                        ...
                                        Text(
                                            ...
                                            style = MaterialTheme.typography.labelSmall.copy(
                                                ...
                                                color = if (isSelected) dev.saifmukhtar.enclave.ui.theme.RoseDeep else Color(0xFF7A6A6C)
                                            )
                                        )
                                    }
                                }
            ...
            Box(modifier = Modifier.padding(paddingValues).consumeWindowInsets(paddingValues).imePadding()) {
                when (currentTab) {
                    ...
                    "music" -> dev.saifmukhtar.enclave.ui.lounge.tabs.MusicLoungeTab(musicSyncController, loungeMusicFactory)
